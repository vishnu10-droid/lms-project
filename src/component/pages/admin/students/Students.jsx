...
const StatCard = ({ icon, label, value, color }) => (
  <div
    className={`flex items-center gap-4 p-4 rounded-2xl border border-slate-100 bg-white shadow-sm`}
  >
...
const StudentCard = ({ student, onDelete }) => (
  <div className="group relative bg-white rounded-2xl border border-slate-200 p-5 shadow-sm hover:shadow-xl hover:border-indigo-200 transition-all duration-300">
    ...
    <div className="absolute inset-y-0 right-0 w-12 bg-slate-900 rounded-r-2xl translate-x-full group-hover:translate-x-0 transition-transform duration-300 flex flex-col items-center justify-center gap-5 opacity-0 group-hover:opacity-100">
