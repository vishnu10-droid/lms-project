...
const menus = [
  { name: "Dashboard", path: "/", icon: LayoutDashboard, color: "from-blue-400 to-indigo-600" },
  ...
  { name: "Analytics", path: "/analytics", icon: BarChart, color: "from-violet-500 to-fuchsia-500" },
];
...
export default function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className="h-[96vh] my-[2vh] ml-[2vh] bg-white/10 backdrop-blur-2xl rounded-3xl border border-white/10 shadow-lg flex flex-col"
    >
      {/* Toggle Button */}
      <button
